...
print("Start dataset")
pca = MiniBatchSparsePCA(n_jobs=-1, batch_size=int(len(dataset_to_process.columns)*0.3))
...
name_export = path_export+"MiniBatch_sparsePCA_dataset.csv"
name_job = path_export+"MinitBatch_sparsePCA_job.joblib"

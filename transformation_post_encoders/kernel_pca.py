...
kernel_value = sys.argv[3]
solver_value = sys.argv[4]
...
print("Start dataset")
pca = KernelPCA(solver=solver_value, kernel=kernel_value, n_jobs=-1)
...
name_export = path_export+"kernel_pca_dataset.csv"
name_job = path_export+"kernel_pca_job.joblib"
